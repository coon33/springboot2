...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		/**
		 * Initialize the config by applying some extensions to jQuery
		 */
		init: function (pathAnim) {
			...
			/**
			 * Register Highcharts as a plugin in the respective fk
			 */
...
// Utility functions. If the HighchartsAdapter is not defined, config is an empty object
